...
- add pasta chamada "routes" referente as rotas "/"
- add pasta só pra armazenar coisas relacionadas ao banco
- add um pasta ou arquivo somente para a organização dos filtros e validações (separada da rota), talvez por meio de classes e metodos??
